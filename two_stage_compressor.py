...
class SmallEmbedder:
    ...
    def __init__(self, model_name: str = "BAAI/bge-small-en-v1.5",
        ...
        # Pinned revision + safetensors only + no remote code. bge-small ships a
        # pytorch_model.bin next to model.safetensors, so the pickle path is
        # genuinely reachable here -- see model_guard's module docstring.
